...
curl -o /home/chembl/notebooks/09_myChEMBL_blast.ipynb https://raw.githubusercontent.com/chembl/mychembl/master/ipython_notebooks/09_myChEMBL_BLAST_and_Druggability.ipynb
